...
<body>
    ...
    <div class="container mt-5">
                    ...
                    <div class="p-5 bg-light border border-dark">
                        ...
                        <form action="#" id="formulario" class="mt-5">
                            <div class="form-group">
                                <label for="select">Santuario: </label>
                            ...
                            <input type="submit" class="mt-4 btn btn-default border border-dark" value="Seleccionar Santuario" name="" id="seleccionar">
                        </form>
                    </div>
                </div>
        ...
        <script src="js/santuario.js"></script>
