<?php
include 'inc/modelos/modelo-admin-ventas.php';
    ...
    <div class="container mt-5">
        ...
        <table class="table table-bordered mt-7">
            ...
            <tbody id="content_table">
                ...
                <?php $registros = obtenerRegistros();
                      
                if ($registros->num_rows) {
                    foreach ($registros as $registros) {
                        $nombre_user = obtenerNombre($registros['id_usuario']);
                        $nombre = $nombre_user->fetch_assoc();
                ?>

                        <tr>
                            <td><?php echo $registros['id_ventas']; ?></td>
                            <td><?php echo $registros['descripcion']; ?></td>
                            <td>$<?php echo $registros['monto']; ?>.00</td>
                            <td><?php echo $nombre['nombre']; ?> <?php echo $nombre['apellidos']; ?></td>
                        </tr>
