...
$resultado = obtenerInfoSantuario($id);
...
<head>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <title>Actualizar Información del Santuario</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center">Actualizar Información del Santuario</h1>
                    ...
                    <div class="p-5 bg-light border border-dark">
                        ...
                        <form action="#" id="formulario" class="mt-5">
                            <div class="form-group">
                                <label for="text">Nombre Santuario:</label>
                                <input type="text" class="form-control" id="nombre" value="<?php echo $registro['nomSant']?>">
                            </div>
                            <div class="form-group">
                                <label for="text">Fecha de Apertura</label>
                                <input type="text" class="form-control" id="fechInicio" value="<?php echo $registro['fecInicio']?>">
                            </div>
                            <div class="form-group">
                                <label for="text">Fecha de Cierre</label>
                                <input type="text" class="form-control" id="fechfin" value="<?php echo $registro['fecfin']?>">
                                <input type="hidden" value="<?php echo $registro['idSantuario']?>" id="idSantuario">
                            </div>
        ...
        <script src="js/santuario2.js"></script>
